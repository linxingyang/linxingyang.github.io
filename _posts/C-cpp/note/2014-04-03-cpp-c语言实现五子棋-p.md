...
title: cpp-c语言实现五子棋
categories: [cpp]
tags: [post, promotion, windows, cpp]
date: 2014-04-03- 11:18:03 +8
place: 福州软件园
editdate: 2021-12-02 11:18:03 +8
eidtplace: 福州软件园
...
C语言五子棋实例
* 需要图形化的支持，参考[cpp-在win7上的C程序图形化界面](http://linxingyang.net/2014/8b072ff2a1da49c2be51643cab4d3agg)
* 图形化相关操作函数，参考[cpp-C语言图形化界面相关函数](http://linxingyang.net/2014/636c838591814906bfc58be14393583a)
