...
![图](http://image.linxingyang.net/image/Z-zoomit/image/2019-12-24/01.png)
...
![图](http://image.linxingyang.net/image/Z-zoomit/image/2019-12-24/02.png)
...
![图](http://image.linxingyang.net/image/Z-zoomit/image/2019-12-24/03.png)
...
![图](http://image.linxingyang.net/image/Z-zoomit/image/2019-12-24/10.png)
...
![图](http://image.linxingyang.net/image/Z-zoomit/image/2019-12-24/04.png)

在draw模式下，输入t进入输入模式
* 字的颜色是当前画笔的颜色
* 字的大小使用ctrl+鼠标滚轮或者，ctrl+up / ctr+down 调节

![图](http://image.linxingyang.net/image/Z-zoomit/image/2019-12-24/11.png)

## break休息

![图](http://image.linxingyang.net/image/Z-zoomit/image/2019-12-24/05.png)

设置时间休息。莫名感觉可以弄一个当番茄时钟。如下按ctrl+3进入休息模式，顺带倒计时。

![图](http://image.linxingyang.net/image/Z-zoomit/image/2019-12-24/12.png)
